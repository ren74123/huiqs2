/*
  ...
  2. Security
    ...
    - Add policies for anyone to view reviews
*/
...
CREATE INDEX idx_package_reviews_user_id ON public.package_reviews(user_id);
CREATE INDEX idx_package_reviews_rating ON public.package_reviews(rating);
...
CREATE INDEX idx_travel_packages_average_rating ON travel_packages(average_rating DESC);