...
DROP POLICY IF EXISTS "id_cards_access_policy_v2" ON storage.objects;
DROP POLICY IF EXISTS "id_cards_read_policy_v1" ON storage.objects;
DROP POLICY IF EXISTS "id_cards_read_policy_v2" ON storage.objects;
...
CREATE POLICY "id_cards_access_policy_v3"
