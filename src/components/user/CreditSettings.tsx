...
import { Coins, CreditCard, AlertCircle, CheckCircle, Info } from 'lucide-react';
    ...
    <div className="space-y-6">
                  ...
                  <div className="flex justify-between items-center">
                    <div>
                      ...
                      <div className="flex items-center mt-1">
                        ...
                        <span className="text-[#F52E6B] font-medium">{pkg.credits} 积分</span>
                    ...
                    <div className="flex flex-col items-end">
                      ...
                      <button
                        ...
                        className="mt-2 bg-[#F52E6B] text-white px-4 py-1 rounded-lg hover:bg-[#FE6587] transition-colors text-sm flex items-center disabled:opacity-50"
                      >
                        <CreditCard className="h-4 w-4 mr-1" />
                        {paymentInProgress ? '处理中...' : '立即购买'}
                      </button>
                    </div>
                  </div>
                </div>
      ...
      {selectedPackage && (
        <AlipayPayModal
          ...
          productName={`${selectedPackage.name}（${selectedPackage.credits}积分）`}
